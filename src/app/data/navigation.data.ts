...
export const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Why DSA', route: '/learn/why-dsa', hint: 'Start here if you are new', badge: 'Start' },
      { label: 'All Chapters', route: '/learn', hint: 'The full curriculum index', exact: true },
      { label: 'Foundations', route: '/learn/foundations', hint: 'Memory, references, the call stack' },
      { label: 'Complexity', route: '/learn/complexity', hint: 'Big-O and how to predict cost' },
      { label: 'Arrays', route: '/learn/arrays', hint: 'Prefix sums, in-place work, Kadane' },
